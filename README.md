...
- Transparent listings (price, type, availability status).
- Easy search and filtering for students.
- A landlord dashboard for managing properties.
...
- **Backend (future scope):** PHP / Node.js
